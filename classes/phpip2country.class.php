	...
	private function dbConnect(){
		if(is_array($this->dbConfig)){
			if(empty($this->dbConfig['host'])){
				$this->dbConfig['host'] = ''; //setting default mysql port name
			...
			if(empty($this->dbConfig['dbUserName'])){
				$this->dbConfig['dbUserName'] = ''; //setting default mysql port name
			...
			if(empty($this->dbConfig['dbUserPassword'])){
				$this->dbConfig['dbUserPassword'] = ''; //setting default mysql port name
