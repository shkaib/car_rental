...
$_CONFIG['site_name'] 			= "Rent A Car";
$_CONFIG['site_short_name'] 	= "Rent A Car";
$_CONFIG['admin_email'] 		= "";

if($_SERVER['HTTP_HOST'] == "localhost"){
//echo 'hiii';exit;
	$_CONFIG['site_url'] 		= "http://www.expressrcar.com/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/";
} else {
	$_CONFIG['site_url']          = "https://".$_SERVER['SERVER_NAME']."/";
	$_CONFIG['site_path']         = $_SERVER['DOCUMENT_ROOT'] . "/";
}
...
$_CONFIG['business_logo_url'] 	= $_CONFIG['site_url'] . "business_logo/";
$_CONFIG['business_logo_path']	= $_CONFIG['site_path'] . "business_logo/";
$_CONFIG['business_thumb_url'] 	= $_CONFIG['business_logo_url'] . "thumb/";
$_CONFIG['business_thumb_path']	= $_CONFIG['business_logo_path'] . "thumb/";
...
// Guide paths
$_CONFIG['guide_url']	 		= $_CONFIG['site_url'] . "guide_file/";
$_CONFIG['guide_path']	 		= $_CONFIG['site_path'] . "guide_file/";
$_CONFIG['guide_resume_url']	= $_CONFIG['guide_url'] . "resume/";
$_CONFIG['guide_resume_path']	= $_CONFIG['guide_path'] . "resume/";
$_CONFIG['guide_resume_template_url']	= $_CONFIG['guide_url'] . "resume_template/";
$_CONFIG['guide_resume_template_path']	= $_CONFIG['guide_path'] . "resume_template/";

// File Attachment
$_CONFIG['attachment_url']	 	= $_CONFIG['site_url'] . "attachment/";
$_CONFIG['attachment_path']	 	= $_CONFIG['site_path'] . "attachment/";

// University Files
$_CONFIG['university_url']	 	= $_CONFIG['site_url'] . "university/";
$_CONFIG['university_path']	 	= $_CONFIG['site_path'] . "university/";
