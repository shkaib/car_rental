...
$GetContentRecord = $objContent->getContent('limousine');?>
...
<?php echo $GetContentRecord["cms_detail"];?>  
   ...
   <form method="post" name="frm_bookingstep3" action="" enctype="multipart/form-data">
            ...
            <div class="person-information status_register" style="display:;"  >
              ...
              <div class="form-group row">
               <!-- <div class="col-sm-12 col-md-12">
                  <label class="required">Select Limousine</label>
                  <select name="leas_type" id="txt_type">
                    <option value="1">Ford.Taurus 2016</option>
                    <option value="2">Chevrolet. Impala 2016</option>       
                    <option value="3">BMW 740 2015</option>       
                    <option value="4">Mercedes E300 2015</option>       
                    </select>
                </div>-->
