...
<section id="content" class="gray-area">
  <div class="container">
    <div class="row">
	  ...
	  echo '</pre>';*/
	  ?>
      <form method="post" name="frm_bookingstep3" id="frm_bookingstep3" action="<?php echo Route::_('show=payments');?>" enctype="multipart/form-data">
          ...
          <div class="booking-section travelo-box">
            <div class="person-information status_register" style=""  >
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6 col-md-6"> 
                <label class="required">Mode of pay</label>
                <input type="radio" checked name="paytype" value="debit">Debit card<br>
                <input type="radio"  name="paytype" value="credit"> Credit card<br>
                </div>
              </div>
              <hr />
...
<!--                      <div class="radio">
                ...
                <dl class="other-details">
                  <table width="100%">
					...
					//$extrafeature_amount += $ExtraFeature["feature_price"];
					 $TotalFinalAmount += $ExtraFeature["feature_price"] * $numberDays;
                      ...
                      <?php foreach ($ExtraFeatureList as $value) {?>
                      
                       <input type="hidden" name="chk[]" value="<?php echo $value["extra_feature_id"];?>" />
                    <tr >
                        <td class="feature" align="left"><strong><?php echo $value["feature_name"];?></strong></td>
                        <td class=""></td>
                        <td class="" align="right">BD <?php echo $value["feature_price"] * $numberDays;?> </td>
                      </tr>
                  ...
                  <dd class="total-price-value"><strong>BD <span id="rental_charge_online_total"><?php echo $TotalAmountPass + $TotalFinalAmount;?> </span> </strong></dd>
                </dl>
              </div>
            </div>

            <input type="hidden" name="total_amount" value="<?php echo $TotalAmountPass + $TotalFinalAmount;?>" />
            <div class="form-group row">
