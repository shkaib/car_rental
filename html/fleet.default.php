              ...
              <article class="box seller-badged"> 
                ...
                <div class="col-md-3">
                  <div class="action">
                    ...
                    <small> Price for <?php echo $numberDays;?> day(s) <span class="price" style="text-decoration:line-through"> BD 
					<?php $CPM = $CarList["product_price"] * $numberDays; echo $CPm + $PickupLocation["location_price"];?> </span><br />
                    ...
                    <?php } else { ?>
   					<small> Per day <span class="price"> BD 
					
					<?php echo $CarList["product_price"];?> </span></small>
                    <?php } ?>
                    ...
                    <a href="<?php echo Route::_('show=bk&ci='.EncData($CarList["product_id"]));?>" class="btn btn-lg btn-primary book_button">Book</a> </div>
                </div>
              </article>
              <?php } 
			} else {
