...
<div class="control-group">
    ...
    <div class="controls">
	<input id="product_price" name="product_price" value="<?php echo $product_price;?>" class="input-xlarge" type="text" tabindex="4">
    </div>
...
<div class="control-group">
    ...
    <div class="controls">
	<input id="price_weekly" name="price_weekly" value="<?php echo $price_weekly;?>" class="input-xlarge" type="text" tabindex="5">
    </div>
    <span>Rent amount only in number format.</span>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
	<input id="price_monthly" name="price_monthly" value="<?php echo $price_monthly;?>" class="input-xlarge" type="text" tabindex="6">
    </div>
    <span>Rent amount only in number format.</span>
</div>
						...
						<div class="data-container">
							...
							<section>
                                ...
                                <table width="100%" border="0" cellspacing="5" cellpadding="5">
                                  ...
                                  <tr>
                                    <th>Image</tH>
                                    <td><?php if($product_image!=''){?><img src="<?php echo SITE_URL .'product_image/orig/' . $product_image;?>" width="300" /><?php } ?></td>
                                  </tr>
                                </table>
